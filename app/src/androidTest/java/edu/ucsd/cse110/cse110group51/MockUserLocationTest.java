...
public class MockUserLocationTest {
    ...
    @Test
    public void mockUserLocationTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.lat),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("32.73459618734685"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.lng),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("-117.14936"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.lat),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("32.735851415117665"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.lng),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("-117.16289416740442"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(android.R.id.text1), withText("User is currently at a chosen exhibit: Siamangs. Please select NEXT to obtain the directions to the next exhibit."),
                        withParent(allOf(withId(R.id.directions_view),
                                withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
        textView2.check(matches(withText("User is currently at a chosen exhibit: Siamangs. Please select NEXT to obtain the directions to the next exhibit.")));
    }
